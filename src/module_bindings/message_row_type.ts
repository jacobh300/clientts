...
export namespace MessageRow {
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: MessageRow): void {
    MessageRow.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): MessageRow {
    return MessageRow.getTypeScriptAlgebraicType().deserialize(reader);
  }
